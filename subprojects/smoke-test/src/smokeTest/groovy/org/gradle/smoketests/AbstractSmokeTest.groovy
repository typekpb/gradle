...
abstract class AbstractSmokeTest extends Specification {
    ...
    private static final Map<String, FileTreeDeprecation> TASK_TO_FILE_TREE_PROPERTY_WARNING = [
        "compileDebugAidl": fileTreeDeprecation("sourceFiles", "TODO"),
        "compileDebugRenderscript": fileTreeDeprecation("sourceDirs", "TODO"),
        "stripDebugDebugSymbols": fileTreeDeprecation("inputFiles", "TODO"),
